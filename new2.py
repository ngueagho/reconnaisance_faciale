...
#     # Get the list of all people in the dataset
...
#     def process_image(person_name, image_file):
#         """Process each image file."""
#         image_path = os.path.join(dataset_path, person_name, image_file)
#         try:
...
#                 executor.submit(process_image, person_name, image_file)
...
#     def verify_person():
#         input_name = simpledialog.askstring("Verify Identity", "Enter Name:")
#         if input_name:
